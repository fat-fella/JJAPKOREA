                    ...
                    <div class="jkNavArea">
                        ...
                        <ul class="serviceNav">
                            ...
                            <li class="navItem lyNull theme" id="theme">
                                <a href="<%=request.getContextPath() %>/onpick/onpick.jsp" class="linkItem"><span class="spNav"><span class="txIr">원픽</span></span></a>
                            </li>
                ...
                <div class="bnr-service">
                    <div class="swiper-container bnr-swiper">
                        <ul class="swiper-wrapper">
                            <li class="swiper-slide" data-swiper-slide-index="2" style="width: 214px;">
                                <a href="/top100" target="_blank">
                                    <img src="//i.jobkorea.kr/content/images/personal/main/sv-banner1.png" alt="">
                                </a>
                            </li>
                            <li class="swiper-slide" data-swiper-slide-index="1" style="width: 214px;">
                                <a href="/User/Qstn/Index" target="_blank">
                                    <img src="//i.jobkorea.kr/content/images/personal/main/sv-banner2.png" alt="">
                                </a>
                            </li>
                            <li class="swiper-slide" data-swiper-slide-index="0" style="width: 214px;">
                                <a href="/Review/MyReview" target="_blank">
                                    <img src="//i.jobkorea.kr/content/images/personal/main/sv-banner3.png" alt="">
                                </a>
                            </li>
                        </ul>
                        <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
                        <div class="btn-control">
                            <div class="bnrs-prev" tabindex="0" role="button" aria-label="Previous slide"></div>
                            <div class="bnrs-next" tabindex="0" role="button" aria-label="Next slide"></div>
                        </div>
                    </div>
                </div>
                <div class="bnr-marketing"><a href="https://yellow.contentsfeed.com/RealMedia/ads/click_lx.ads/jobkorea/main/L13/392175146/Right3/jobkorea/230421_jnshipjump_mr_s/230413_jklotte_mr.html/41643134773253614c45454143545249" target="_blank"><img src="//apple.contentsfeed.com/RealMedia/ads/Creatives/jobkorea/230421_jnshipjump_mr_s/230510_jnshipjump_260_90.png" border="0" alt="전남조선업도약센터 "></a></div>
            </div>
