...
<head>
	...
	<!-- contwrap -->
    <link rel="stylesheet" href="<%=request.getContextPath() %>/member/css/jobkh_mypage.css">
    <!-- swiper css -->
...
<body>
 <div class="contWrap">
    <div class="mtuTab devFixedTab">
        <ul>
            <li class="on">
                <a href="/user/mypage" onclick="GA_Event('마이페이지_PC', '나의소식', '스크랩 공고')">스크랩 공고</a>
            </li>
            <li>
                <a href="/user/mypage?PageFlag=RE" onclick="GA_Event('마이페이지_PC', '나의소식', '최근 본 공고')">최근 본 공고</a>
            </li>
            <li>
                <a href="/user/mypage?PageFlag=SM" onclick="GA_Event('마이페이지_PC', '나의소식', '스마트매치')">스마트매치</a>
            </li>
            <!--li>
    ...
    <div class="mtuList boothList smartMatchList" id="smartMatch">
        <ul>
                <li class="mtuNoData">
                    스크랩한 공고가 없습니다. <br>스크랩 관리 내역은 최대 3개월까지 확인하실 수 있습니다.
                    <div class="btnWrap"><a class="btnLink mtuSpImgAfter" href="/Recruit/Home">채용정보 보기</a></div>
                </li>

        </ul>
    </div>
    <div class="btnMoreBlock"><a class=" mtuSpImgAfter" href="/user/scrap/index" onclick="GA_Event('마이페이지_PC', '나의소식', '스크랩공고 더보기')">스크랩공고 더보기</a></div>
