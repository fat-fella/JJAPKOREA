...
//		String result = new MemberServiceImpl().login(mid);
...
//				
//				String pname = new MemberServiceImpl().indexLogin(mid); // 사용자 이름을 가져오는 메서드 호출
...
//			String result2 = new MemberServiceImpl().businessLogin(mid2);
//			if(mpw2 == null) {
//				// 아이디가 존재하지 않습니다.
...
//				
//				String pname2 = new MemberServiceImpl().indexLogin(mid2); // 사용자 이름을 가져오는 메서드 호출
