...
public class ResumeWriteController {
	...
	public String resumeMgr(Model model, ResumeWriteDto resumeWriteDto, @RequestParam List<String> qualificationName,
			@RequestParam List<String> qualificationDate, @RequestParam List<String> qualificationAuthority,
			@RequestParam List<String> educationPeriod, @RequestParam List<String> schoolName,
			@RequestParam List<String> major, @RequestParam List<String> workPeriod,
			@RequestParam List<String> workPlace, @RequestParam List<String> workDetails,
			@RequestParam List<String> awardName, @RequestParam List<String> awardingAuthority,
		...
		if (!resumeWriteDtos.isEmpty()) {
			...
			resumeId = resumeWriteDto.getResumeId();
		}
