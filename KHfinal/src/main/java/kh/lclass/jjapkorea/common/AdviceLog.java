...
public class AdviceLog {
	...
	@Pointcut("execution(public * kh.lclass.jjapkorea..*Dao.*(..))")
	public void daoPointCut() {}
	@Pointcut("execution(public * kh.lclass.jjapkorea..*Service.*(..))")
	public void servicePointCut() {}
	@Pointcut("execution(public * kh.lclass.jjapkorea..*Controller.*(..))")
