...
<title>JJapKorea | 멤버 관리 페이지</title>
...
<body class="sb-nav-fixed">
			...
			<main>
				<div class="container-fluid px-4">
					<div class="Menu_container">
						<ul class="Menu_list">
							<li style="font-weight: bold;"><a>기업 멤버 리스트</a></li>
						</ul>
					</div>
	...
	<script>
		...
		$(".pageInfo a").on("click", function(e) {
			...
			moveForm.attr("action", "${pageContext.request.contextPath}/admin/businessList");
			moveForm.submit();
		});
		...
		$(".suspended_btn").on("click", function() {
	        ...
	        $.ajax({
	            ...
	            success: function(response) {
	                // 성공 시 수행할 로직
	                location.href="${pageContext.request.contextPath}/admin/businessList";
