				...
				<div class="jkNavArea">
					...
					<ul class="userNav" style="">
						...
						<li class="userNav-item notification devLiNotification">
							<a href="javascript:void(0)" class="bell notify" id="js-bell"
								onclick="GA_Event('공통_PC', 'gnb', '알림');">
								알림 <span id="js-alarmCnt" class=""> 0 </span>
							</a>
						...
						<ul id="devMyPage" class="userNav">
							<li class="userNav-item my member">
								<a href="<%=request.getContextPath() %>/mypage"
									...
									<span class="spGnb"></span><span class="user-name">${pname}</span>
								...
								<div class="lyMyArea">
									<div class="myInner">
										<div class="myLists">
											<ul>
												<li>
													<a href="#" onclick="GA_Event('공통_PC', 'gnb', '이력서 관리');">
														<span class="tx">이력서 관리</span>
													</a>
												</li>
												<li>
													<a href="#" onclick="GA_Event('공통_PC', 'gnb', '입사지원 현황');">
														<span class="tx">입사지원 현황</span>
													</a>
												</li>
												<li>
													<a href="#" onclick="GA_Event('공통_PC', 'gnb', '이력서 열람기업');">
														<span class="tx">이력서열람 기업</span>
													</a>
												</li>
												<li>
													<a href="#" onclick="GA_Event('공통_PC', 'gnb', '스마트매치');">
												...
												<li>
													<a href="#" onclick="GA_Event('공통_PC', 'gnb', '개인정보 수정');">
