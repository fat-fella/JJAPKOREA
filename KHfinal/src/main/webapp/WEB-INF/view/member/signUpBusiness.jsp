<link rel="stylesheet" href="<%=request.getContextPath()%>/resources//member/css/jobkh_signup.css">
						...
						<div class="row certificate_num">
							...
							<div class="col_2">
								<input type="text" name="CRTFCT_Issue_No" id="CRTFCT_Issue_No"
									...
									value=""> <input type="hidden" id="CRTFCT_Issue_No1"
								...
								<div class="pvsSec pvsCntTp">
									<ol>
										...
										<li>
											<dl>
												<dt>
													<a name="gg23" id="gg23"></a><strong>제 23 조 (양도
														금지) </strong>
												</dt>
												<dd>
