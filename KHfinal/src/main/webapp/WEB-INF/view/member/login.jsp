	...
	<div id="wrap">
		...
		<div id="container">
			<div class="logtop logtop_login">
				<h1 class="hd">
					<span class="logo"></span>하나의 아이디로 잡코리아, 알바몬 서비스를 모두 이용하실 수 있습니다.
				</h1>
				<p class="lnb">
					<a href="<%=request.getContextPath() %>/index">잡코리아홈</a> <span
						class="txtBar">|</span> <a
						href="http://www.jobkorea.co.kr/Customer_C/CC_Main.asp">고객센터</a>
				</p>
			</div>
				...
				<div class="logWrap" id="loginFormWrite">
					...
					<fieldset class="login_form">
						...
						<input type="hidden" name="idx" value=""> <input
							type="hidden" name="Div" value=""> <input type="hidden"
							name="BNo" value=""> <input type="hidden" id="IP_ONOFF"
							name="IP_ONOFF" value="Y"> <input type="hidden"
							name="Login_Stat" id="Login_Stat" value=""> <input
							type="hidden" name="LoginPage" value="/Login/Login_Tot.asp">
						<input type="hidden" name="returnHost" id="returnHost"
							value="http://www.jobkorea.co.kr"> <input type="hidden"
							name="jkwww_host" id="jkwww_host"
							value="https://www.jobkorea.co.kr"> <input type="hidden"
							name="NaverReferReURL_Stat" id="NaverReferReURL_Stat" value="">
						<input type="hidden" name="DB_Name" id="DB_Name" value="GG">
						<input type="hidden" name="ignoreSession" id="ignoreSession"
							value=""> <input type="hidden" name="mtype" id="mtype"
							value="">
						<!-- 회원선택-->
						...
						<div class="select_row devHide" id="devCoTab"
							style="display: none;">
							<p class="sort">
								<input type="radio" id="lb_memberGi" name="Co_DB_Name"
									value="GI" onclick="fChkIntroGI('Co')" checked=""
									data-href="https://www.jobkorea.co.kr/Join/GI_Regist">
								<label for="lb_memberGi" class="radioOn">기업회원</label> <input
									type="radio" id="lb_memberSf" name="Co_DB_Name" value="SF"
									onclick="fChkIntroGI('Co')"
									data-href="https://www.jobkorea.co.kr/Join/HR_Regist">
								<label for="lb_memberSf">서치펌회원</label>
							</p>
						</div>

						<div class="input_row">
							<label for="M_ID" id="lb_id" class="blind">아이디</label> <input
								type="text" class="inpTxt inpID off" name="mid" id="M_ID"
								size="16" maxlength="20" title="아이디 입력"
								style="ime-mode: inactive;" autocomplete="off"> <label
								for="M_PWD" id="lb_pw" class="blind">비밀번호</label> <input
								type="password" class="inpTxt inpPW devCapsLock off" name="mpw"
								id="M_PWD" size="16" title="비밀번호 입력" autocomplete="off">
						...
						<div class="check_row">
							...
							<label for="lb_idSave">로그인 상태 유지</label> <span class="txtBar">
								| </span> <a href="javascript:void(0)" class="devSecPop">IP보안</a>
						...
						<div class="capck_row loginImgTxt devHide">
							<label for="gtxt" class="blind">그림문자</label> <input type="text"
								class="inpTxt inpCap" name="gtxt" id="gtxt" size="16"
								title="그림문자 입력" autocomplete="off">
						...
						<div class="list-social">
							<ul>
								...
								<li><a href="javascript:;" id="btnFbLogin" class="facebook"
									onclick="facebookLogin(); _LA.EVT('4285')"
									style="display: block;">페이스북 로그인</a></li>
								<li><a href="${ google_url }" id="btnGlLogin"
									class="google" onclick="_LA.EVT('4288')"
									style="display: block;">
										<div class="S9gUrf-YoZ4jf" style="position: relative;">
											<img src="resources/images/google_logo.png" width="40"
												height="40" alt="Google 로고">
										</div>
								</a></li>
								<li><a href="javascript:;" id="btnApLogin" class="apple"
									style="display: block;">애플 로그인</a></li>
							</ul>
						</div>
						...
						<div class="join">
							<div id="M_Alert" style="display: block;">
								좋은 일을 찾으시나요? 회원가입하시고 다양한 혜택을 누리세요! <a
									href="<%=request.getContextPath() %>/psignup" target="_new">회원가입</a>
							</div>
							<div id="Co_Alert" style="display: none;">
								좋은 인재를 구하시나요? 회원가입하시고 다양한 혜택을 누리세요! <a
									href="<%=request.getContextPath() %>/psignup" target="_new">회원가입</a>
			...
			<div class="section-company" style="display: none;">
				...
				<div class="article-start target">
					<div class="inner">
						<img
							...
							alt=""> <a href="https://www.jobkorea.co.kr/Join/GI_Regist"
							class="btn-start"> <img
				...
				<div class="btn-fixed-right">
					<a href="<%=request.getContextPath() %>/psignup"
						class="btn-join-right">가입하기</a> <a href="javascript:;"
						onclick="$('html, body').animate({scrollTop: 0}, 800);"
						class="btn-top btn-top-scroll"> <img
