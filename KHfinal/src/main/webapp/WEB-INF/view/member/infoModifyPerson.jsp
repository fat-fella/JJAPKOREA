...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/infoModifyPerson/mbr_tpl.css">
		...
		<div id="header">
			<div id="gnb">
				...
				<div class="secNav">
					<ol>
						<li class="mn1"><a
							href="${pageContext.request.contextPath}/person/infoModifyPerson"><span></span>개인정보
								수정</a></li>
						<li class="mn2"><a href=#><span></span>비밀번호변경</a></li>
						<li class="mn4"><a href=#><span></span>메일링/문자메시지 설정</a></li>
						<li class="mn3 end"><a href="#"
							onclick="deleteAccount(event); return false;" target="_blank"><span></span>회원탈퇴</a></li>
					</ol>
				</div>
						...
						<p>회원님의 정보를 수정·확인하실 수 있습니다.</p>
							...
							<div class="mbrTplData2">
								<table
									...
									<tbody>
										<tr>
											<th scope="row"><label for="lb_id"><span
													class="blank"></span> 아이디</label></th>
											<td>
										...
										<tr>
											<th scope="row"><span class="blank"></span> 이름 <img
												alt="필수입력사항"
												src="<%=request.getContextPath()%>/resources/images/infoModifyPerson_icon_b.gif"></th>
											<td colspan="3"><input type="text" class="txtForm"
												id="M_Name" name="M_Name" size="12" maxlength="15"
												value="${selectOnePerson.pname}" required> <span
												class="assist chgRealName"></td>
										</tr>
								...
								<select title="성별" name="M_Gender" id="M_Gender" style="width:110px; float:left;" class="ipSelect">
									<option value="성별">성별</option>
										...
										<tr>
											<th scope="row"><span class="blank"><label
													for="pphone"></span> <label for="mpw">비밀번호</label><img
												alt="필수입력사항"
												src="<%=request.getContextPath()%>/resources/images/infoModifyPerson_icon_b.gif"></th>
											<td>
										...
										<tr>
											<th scope="row"><span class="blank"><label
													for="pphone"></span> 휴대폰번호</label> <img alt="필수입력사항"
												src="<%=request.getContextPath()%>/resources/images/infoModifyPerson_icon_b.gif"></th>
											<td>
												<div class="mbrHelpWrap">
													<div class="mobile">
														<div class="pphoneInputBox">
															<div class="pphoneInputBox">
																<input type="text" id="pphone" name="pphone"
																	value="${selectOnePerson.pphone}" required>
															</div>
										...
										<tr>
											...
											<th scope="row"><span class="blank"></span> <label
												for="Email_ID"><label for="pemail">이메일 <img
														alt="필수입력사항"
														src="<%=request.getContextPath()%>/resources/images/infoModifyPerson_icon_b.gif"></label></th>
											<td>
												<div class="mbrHelpWrap">
													<div class="pemailInputBox">
														<input type="email" id="pemail" name="pemail"
															value="${selectOnePerson.pemail}" required>
													</div>

													<div style="left: 455px; display: none;"
														class="mbrTplLayer mbrTplLayer_1 mbrLayerHelp"
														id="CautionResult2" name="CautionResult">
														<div class="desc">
															<p>이메일을 입력해 주세요</p>
														</div>
														<span class="arrow"></span>
							...
							<tr>
								...
								<td colspan="3">
									<div class="mbrHelpWrap">
										...
										<!-- [필수] 개인정보 수집 및 이용 동의-->
										<tr>
											<th scope="row" rowspan="2"><span class="blank"></span>개인정보
												수집 및<br> <span class="blank"></span>이용 동의</th>
											<td>
												<!-- 약관 Show & Hide-->
												<div class="privacy-wrap">
													<div class="privacy-title">
														<label> <input type="checkbox"
															id="PrivacyEssential_Agree" name="PrivacyEssential_Agree"
															value="0"> <span class="label-text">[필수]
																개인정보 수집 및 이용 동의</span>
														</label> <a class="policy-more-button">내용보기</a>
													</div>
													<div class="policy-box">
														<div class="policy-box-content">
															...
															<table class="policy-table">
																...
																<tbody>
																	<tr>
																		<td>구직자 정보 확인 및 통계 활용</td>
																		<td>생년월일, 성별, 휴대폰번호, 이메일</td>
													...
													<div class="tooltip hide">
														<div class="tooltip-wrap">필수 항목에 동의해 주세요.</div>
														<span class="tooltip-arw"> <span
															class="tooltip-arw-wrap"></span>
														</span>
													</div>
												</div> <!-- //약관 Show & Hide-->
											</td>
										...
										<tr>
											<td>
												...
												<div class="privacy-wrap">
													<div class="privacy-title">
														<label> <input type="checkbox"
															id="PrivacyChoice_Agree" name="PrivacyChoice_Agree"
															value="0"> <span class="label-text">[선택]
																개인정보 수집 및 이용 동의</span>
														</label> <a class="policy-more-button">내용보기</a>
													</div>
													<div class="policy-box">
														<div class="policy-box-content">
															<ol>
																...
																<li>4. 수신동의 거부 및 철회방법 안내
																	<p>본 동의는 거부하실 수 있습니다. 다만 거부 시 동의를 통해 제공 가능한 각종 혜택,
																		이벤트 안내를 받아보실 수 없습니다. 더 이상 상품•서비스 영업, 홍보, 마케팅, 쿠폰 발송을
																		원하시지 않는 경우 회원정보수정 페이지에서 수신여부를 변경하실 수 있습니다.</p>
																</li>
															</ol>
														</div>
													</div>
	...
	for (i=0; i<=4; i++){
	    ...
	    <div class="footer__service">
            ...
            <ul>
                ...
                <li><a href="#" target="_blank">브랜드 스토리</a></li>
        ...
        <p class="copyright">ⓒ <strong><a href="${pageContext.request.contextPath}/index"" target="_blank">JJOBKOREA</a></strong> LLC. All rights reserved.</p>
