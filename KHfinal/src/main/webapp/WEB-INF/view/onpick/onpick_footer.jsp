		...
		<div class="footer__wrap">
			<div class="footer__advertisement clear">
				<p class="footer__advertisement--text">
					<iframe width="195" height="35" frameborder="0" scrolling="no"
						marginwidth="0" marginheight="0"
						src="https://yellow.contentsfeed.com/RealMedia/ads/adstream_sx.ads/jobkorea/sub@Frame1"
						title="광고"></iframe>
				</p>
				<p class="footer__advertisement--image">
					<iframe width="520" height="110" noresize="" scrolling="no"
			...
			<div class="footer__notice">
				<dl class="footer__notice-wrap clear">
					...
					<dd class="footer__notice-text">
						<a href="#">
							<div class="ellipsis">[사전공지] 개인회원 만 나이 시행 안내</div>
							<em class="tahoma">23.06.21</em>
						</a>
					</dd>
				</dl>
			...
			<p class="copyright">
				© <strong><a href="#">JOBKOREA</a></strong> LLC. All rights
				reserved.
			</p>
		</div>
	</div>
