...
CREATE TABLE "CHAT" (
	"MID"	VARCHAR2(20)		NOT NULL,
	"C_CONT"	VARCHAR2(500)		NULL,
	"C_DATE"	DATE		NULL,
	"R_UUID"	VARCHAR2(200)		NOT NULL
);
...
COMMENT ON COLUMN "INFO"."RECRUIT_FIELD" IS '채용분야 소분류 코드';
...
CREATE TABLE "RFIELD" (
	"RECRUIT_FIELD"	VARCHAR2(20)		NOT NULL,
	"FIELD_TITLE"	VARCHAR2(50)		NOT NULL
);
...
CREATE TABLE "API_SNS_LOGIN" (
	"NMID"	VARCHAR2(20)		NOT NULL,
	"GMID"	VARCHAR2(20)		NOT NULL,
...
ALTER TABLE "API_SNS_LOGIN" ADD CONSTRAINT "PK_API_SNS_LOGIN" PRIMARY KEY (
	"NMID",
	"GMID",
	"MID"
);
...
ALTER TABLE "API_SNS_LOGIN" ADD CONSTRAINT "FK_MEMBER_TO_API_SNS_LOGIN_1" FOREIGN KEY (
	"MID"
)
REFERENCES "MEMBER" (
	"MID"
